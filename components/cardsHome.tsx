...
export default function CardsContainerHome() {
    return (
        <div className="flex flex-col">
            ...
            <div className="grid h-96 gap-1 sm:grid-cols-3 mt-4">
                <div className="sm:col-span-1">
                    <Link href="/collections/collection">
                        <div className="block bg-white h-96 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white">
                            {/* Contenido de tu tarjeta */}
            ...
            <div className="flex flex-col ">
                <div className="sm:w-full sm:font-bold text-6xl mt-4 mb-5">
                    <h2 className=" sm:w-full text-center sm:mx-auto">
                        Nuevos Productos de ChainSaw Man
                    </h2>
                </div>
                <ImageSlider2 />
            </div>
